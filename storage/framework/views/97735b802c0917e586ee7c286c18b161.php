...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ধানমন্ডি ১৫ নং গভঃ ষ্টাফ কোয়ার্টার্স প্রাক্তন নিবাসী ফোরাম'); ?></title>

    
    <link rel="shortcut icon" href="<?php echo e(asset('images/logo-square.png')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('images/logo-square.png')); ?>">

    
    <meta property="og:image" content="<?php echo e(asset('images/logo-square.png')); ?>">
        ...
        <nav class="admin-navbar">
            <div class="container d-flex flex-wrap align-items-center justify-content-between gap-2">
                ...
                <a class="navbar-brand" href="<?php echo e(route('admin.dashboard')); ?>">
                    <img src="<?php echo e(asset('images/logo-square.png')); ?>"
                         alt="D15"
                         class="brand-logo"
                ...
                <div class="d-flex flex-wrap align-items-center gap-1">
                    <a href="<?php echo e(route('admin.registrations')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.registrations') && !request('payment') ? 'active' : ''); ?>">
                        Registrations
                    </a>

                    <a href="<?php echo e(route('admin.registrations', ['payment' => 'pending'])); ?>"
                       class="nav-link <?php echo e(request('payment') === 'pending' ? 'active' : ''); ?>">
                        Pending
                        <?php if($pendingCount): ?>
                            <span class="badge badge-pending"><?php echo e($pendingCount); ?></span>
                        <?php endif; ?>
                    </a>

                    <a href="<?php echo e(route('admin.sms.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.sms.*') ? 'active' : ''); ?>">
                        SMS
                    </a>

                    <?php if(auth()->user()->role !== 'moderator'): ?>
                        <a href="<?php echo e(route('admin.bkash.index')); ?>"
                           class="nav-link <?php echo e(request()->routeIs('admin.bkash.*') ? 'active' : ''); ?>">
                            bKash
                        </a>
        ...
        <div class="container">
            <div class="header-banner-wrap">
                <a href="<?php echo e(route('home')); ?>" class="d-block">
                    <img src="<?php echo e(asset('images/banner-logo.png')); ?>"
...
<?php if(!request()->routeIs('admin.*')): ?>
    <footer class="py-4 text-center text-muted small">
        <div class="container">
            &copy; <?php echo e(date('Y')); ?> ধানমন্ডি ১৫ নং গভঃ ষ্টাফ কোয়ার্টার্স প্রাক্তন নিবাসী ফোরাম
        </div>
    </footer>
<?php endif; ?>
...
</html><?php /**PATH D:\optimumstudio\15_No\dhanmondi15\resources\views/layouts/app.blade.php ENDPATH**/ ?>